...
<script>
    ...
    function addInput1(divName) {
        if (counter == limit) {
            ...
            "<input class='f_block' type='text' id='cas' name='cas[]' placeholder=' Case ' autofocus><br><br>" +

            "<label><u>Number</u> : &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</label>" +
            "<input class='f_block' type='text' id='num' name='num[]' placeholder=' Number ' autofocus><br><br>" +
            
            "<label><u>Person</u> : &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</label>" +
            "<input class='f_block' type='text' id='prsn' name='prsn[]' placeholder=' Person ' autofocus><br><br>" +
            ...
            "<label><u>Ending</u> : &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</label>" +
            "<input class='f_block' type='text' id='endg' name='endg[]' placeholder=' Ending ' autofocus><br><br>" +
      ...
      <div class="well ff">
	   ...
	   <div class="box" style="margin-left: 200px; margin-right: 110px; padding-top: 30px; padding-left: 50px; padding-right: 30px;" >
		<form action="entry.php" method="POST">            
		    ...
		    <input class="f_block" type="text" id="word" name="word" placeholder=" Word(in sanskrit) " autofocus><br><br>
            
            <label><u>Hin - Word</u> : &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</label>
		    <input class="f_block" type="text" id="word_h" name="word_h" placeholder=" Word (in hindi) " autofocus><br><br>
