...
<p>  </p>
    <div class="col-sm-12">
      <div class="well ff">
          ...
          <center><h1 style="color: #b200ff;">ASSAMESE &nbsp WORD</h1></center><hr style="display: block; border-color: #0026ff" >
          </div>
		...
		<form action='entry_modify.php' method='POST'>            
            ...
            foreach($ent as $entry)
            {
                if($entry->getElementsByTagName('word')->item(0)->nodeValue==$word){
                    ...
                    $wrd3=$entry->getElementsByTagName('word_s')->item(0)->nodeValue;
                    $wrd4=$entry->getElementsByTagName('word_e')->item(0)->nodeValue;
		    ...
		    <input class='f_block' type='text' id='lng' name='lng' style='width: 100px;' value='ASSAMESE' readonly ><br><br>
            </div>
		    ...
		    <input class='f_block' type='text' id='word_s' name='word_s' value='$wrd3' autofocus><br><br>

            <label><u>Eng - Word</u> : &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</label>
		    <input class='f_block' type='text' id='word_e' name='word_e' value='$wrd4' autofocus><br><br>
            ...
            foreach($par as $para){
                 ...
                 $sy=$para->getElementsByTagName('syn');
                 $an=$para->getElementsByTagName('ant');
                 $pl=$para->getElementsByTagName('pl');
                 $ph=$para->getElementsByTagName('phr')->item(0)->nodeValue;
            ...
            <label><u>Definition</u> : &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</label>
		    <input class='f_block' type='text' id='def' style='width: 500px;' name='def[]' value='$df' autofocus><br><br>";

            foreach($sy as $s){
                $r=$s->nodeValue;
            echo "<label><u>Synonym</u> : &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</label>
		    <input class='f_block' type='text' id='syn' name='syn[]' value='$r' autofocus><br><br>";
            }

            
            foreach($an as $s){
                $r=$s->nodeValue;
            echo "<label><u>Antonym</u> : &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</label>
		    <input class='f_block' type='text' id='ant' name='ant[]' value='$r' autofocus><br><br>";
            }
            echo "<label><u>Phrase</u> : &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</label>
		    <input class='f_block' type='text' id='phr' name='phr[]' value='$ph' autofocus><br><br>
            ...
            foreach($pl as $s){
                $r=$s->nodeValue;
            echo "<label><u>Plural</u> : &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</label>
		    <input class='f_block' type='text' id='pl' name='pl[]' value='$r' autofocus><br><br>";
            }
