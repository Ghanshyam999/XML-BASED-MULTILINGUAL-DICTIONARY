...
<p>  </p>
    <div class="col-sm-12">
      <div class="well ff">
          ...
          <center><h1 style="color: #b200ff;">ENGLISH &nbsp WORD</h1></center><hr style="display: block; border-color: #0026ff" >
          </div>
	   ...
	   <div class="box" style="margin-left: 200px; margin-right: 50px; padding-top: 30px; padding-left: 50px; padding-right: 30px;" >
		<form action='entry_modify.php' method='POST'>            
		    ...
		    <input class='f_block' type='text' id='lng' name='lng' style='width: 100px;' value='ENGLISH' readonly ><br><br>
            </div>
