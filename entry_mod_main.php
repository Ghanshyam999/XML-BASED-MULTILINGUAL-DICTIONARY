...
<p>  </p>
    <div class="col-sm-12">
      <div class="well ff">
          ...
          <center><h1 style="color: #b200ff;">MODIFY &nbsp WORD</h1></center><hr style="display: block; border-color: #0026ff" >
          </div>
	   ...
	   <div class="box" style="margin-left: 200px; margin-right: 50px; padding-top: 30px; padding-left: 50px; padding-right: 30px;" >
		<form action="modify.php" method="POST">            
            ...
            <input type='submit' class='btn btn-primary btn-md pull-right' name='submit' value='Search'>
